...
export default function BioContent({ activeTab, darkMode }) {
    ...
    return (
        <main className="bio-switcher" style={{ position: 'relative', minHeight: '300px' }}>
            <AnimatePresence mode="wait">
                {activeTab === 'short' && (
                    <motion.section
                        key="short"
                        className="bio short show"
